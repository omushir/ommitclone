...
var React = _interopRequireWildcard(__webpack_require__(540));
var _propTypes = _interopRequireDefault(__webpack_require__(556));
var _reactDom = _interopRequireDefault(__webpack_require__(961));
var _clsx = _interopRequireDefault(__webpack_require__(53));
var _domFns = __webpack_require__(89);
var _positionFns = __webpack_require__(726);
var _shims = __webpack_require__(56);
var _DraggableCore = _interopRequireDefault(__webpack_require__(888));
var _log = _interopRequireDefault(__webpack_require__(696));
...
var _shims = __webpack_require__(56);
var _getPrefix = _interopRequireWildcard(__webpack_require__(514));
function _getRequireWildcardCache(nodeInterop) { if (typeof WeakMap !== "function") return null; var cacheBabelInterop = new WeakMap(); var cacheNodeInterop = new WeakMap(); return (_getRequireWildcardCache = function (nodeInterop) { return nodeInterop ? cacheNodeInterop : cacheBabelInterop; })(nodeInterop); }
function _interopRequireWildcard(obj, nodeInterop) { if (!nodeInterop && obj && obj.__esModule) { return obj; } if (obj === null || typeof obj !== "object" && typeof obj !== "function") { return { default: obj }; } var cache = _getRequireWildcardCache(nodeInterop); if (cache && cache.has(obj)) { return cache.get(obj); } var newObj = {}; var hasPropertyDescriptor = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var key in obj) { if (key !== "default" && Object.prototype.hasOwnProperty.call(obj, key)) { var desc = hasPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : null; if (desc && (desc.get || desc.set)) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } newObj.default = obj; if (cache) { cache.set(obj, newObj); } return newObj; }
...
;// ./src/components/BlockPalette.js
function BlockPalette_extends() { return BlockPalette_extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, BlockPalette_extends.apply(null, arguments); }
...
const blocks = [{
  ...
  id: 'motion-turn-clockwise',
  type: 'motion-turn-clockwise',
  label: 'Turn _ degrees clockwise'
}, {
  id: 'motion-turn-counterclockwise',
  type: 'motion-turn-counterclockwise',
  label: 'Turn _ degrees counter-clockwise'
}, {
  id: 'motion-goto',
  type: 'motion-goto',
  label: 'Go to x: 0 y: 0'
...
function BlockPalette() {
  return (
    ...
    react.createElement("div", {
      className: "w-64 bg-gradient-to-b from-blue-400 to-blue-300 p-6 border border-blue-500 shadow-lg rounded-lg"
    }, /*#__PURE__*/react.createElement("h2", {
      className: "text-xl font-semibold text-white mb-4"
    }, "Motion"), /*#__PURE__*/react.createElement(ConnectedDroppable, {
      droppableId: "block-palette",
      isDropDisabled: true
    }, provided => /*#__PURE__*/react.createElement("div", BlockPalette_extends({}, provided.droppableProps, {
      ref: provided.innerRef
    }), blocks.map((block, index) => /*#__PURE__*/react.createElement(PublicDraggable, {
      key: block.id,
      draggableId: block.id,
      index: index
    }, (provided, snapshot) => /*#__PURE__*/react.createElement("div", BlockPalette_extends({
      ref: provided.innerRef
    }, provided.draggableProps, provided.dragHandleProps, {
      className: `bg-gradient-to-r from-yellow-400 to-yellow-500 p-3 mb-3 rounded-md shadow-lg hover:shadow-xl transition-transform transform ${snapshot.isDragging ? 'opacity-70 scale-105' : 'scale-100'}`
    }), /*#__PURE__*/react.createElement("span", {
      className: "text-gray-800 font-medium"
    }, block.label)))), provided.placeholder)))
  );
}
/* harmony default export */ const components_BlockPalette = (BlockPalette);
;// ./src/components/ScriptArea.js
function ScriptArea_extends() { return ScriptArea_extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, ScriptArea_extends.apply(null, arguments); }
// Import necessary dependencies
...
function ScriptArea(_ref) {
  ...
  const handleInputChange = (scriptId, paramName, value) => {
    updateSprite(sprite.id, {
      scripts: sprite.scripts.map(script => script.id === scriptId ? {
        ...script,
        params: {
          ...script.params,
  ...
  const renderScript = (script, index) => /*#__PURE__*/react.createElement(PublicDraggable, {
    key: script.id,
    draggableId: script.id.toString(),
    index: index
  }, provided => /*#__PURE__*/react.createElement("div", ScriptArea_extends({
    ref: provided.innerRef
  }, provided.draggableProps, provided.dragHandleProps, {
  ...
  }, script.type === 'control-forever' && /*#__PURE__*/react.createElement("span", {
    className: "font-bold mr-2"
  }, "Forever"), script.type === 'motion-move' && /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("span", {
    ...
    className: "ml-2"
  }, "steps")), script.type === 'motion-turn-clockwise' && /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("span", {
    className: "font-semibold"
  }, "Turn"), /*#__PURE__*/react.createElement("input", {
    type: "number",
    ...
    className: "ml-2"
  }, "degrees clockwise")), script.type === 'motion-turn-counterclockwise' && /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("span", {
    className: "font-semibold"
  }, "Turn"), /*#__PURE__*/react.createElement("input", {
    type: "number",
    value: script.params.degrees,
    ...
    className: "ml-2"
  }, "degrees counter-clockwise")), script.type === 'motion-goto' && /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("span", {
    className: "font-semibold"
  }, "Go to x:"), /*#__PURE__*/react.createElement("input", {
    type: "number",
  ...
  return /*#__PURE__*/react.createElement("div", {
    className: "p-6 bg-white border-2 border-gray-300 shadow-inner h-full overflow-y-auto rounded-lg"
  }, /*#__PURE__*/react.createElement("h2", {
    className: "text-xl font-bold mb-4 text-gray-900"
  }, sprite.name, " Scripts"), /*#__PURE__*/react.createElement(ConnectedDroppable, {
    droppableId: "script-area"
  }, (provided, snapshot) => /*#__PURE__*/react.createElement("div", ScriptArea_extends({}, provided.droppableProps, {
    ref: provided.innerRef,
    style: {
      minHeight: '200px',
  ...
  }), sprite.scripts.map((script, index) => renderScript(script, index)), provided.placeholder)));
}
/* harmony default export */ const components_ScriptArea = (ScriptArea);
// EXTERNAL MODULE: ./node_modules/react-draggable/build/cjs/cjs.js
var cjs = __webpack_require__(794);
...
// Stage component to render and manage sprites
function Stage(_ref) {
  let {
    sprites,
    width,
  ...
  // Function to render individual sprite
  const renderSprite = sprite => /*#__PURE__*/react.createElement((cjs_default()), {
    key: sprite.id,
    position: {
      x: sprite.x,
      y: sprite.y
    },
    onStop: (e, data) => onSpriteDrag(sprite.id, data.x, data.y),
    bounds: "parent"
  }, /*#__PURE__*/react.createElement("div", {
  ...
  // Render the stage with all sprites
  return /*#__PURE__*/react.createElement("div", {
    className: "relative bg-teal-100 overflow-hidden border-2 border-gray-300",
    style: {
      width,
      height
    }
...
function SpriteSelector(_ref) {
  ...
  return (
    ...
    }, sprites.map(sprite => /*#__PURE__*/react.createElement("div", {
      key: sprite.id,
      className: `p-3 rounded-lg flex items-center justify-between cursor-pointer transition-transform transform hover:scale-105 shadow-md ${sprite.id === selectedSpriteId ? 'bg-blue-600 text-white' : 'bg-blue-500 text-white'}`,
      onClick: () => onSelectSprite(sprite.id)
    }, /*#__PURE__*/react.createElement("span", {
      className: "flex-grow font-semibold"
    }, sprite.name), /*#__PURE__*/react.createElement("button", {
...
function App_App() {
  ...
  const [selectedSpriteId, setSelectedSpriteId] = (0,react.useState)(1);

  // Refs for managing intervals and running state
  const intervalsRef = (0,react.useRef)({});
  ...
  const executeScript = (0,react.useCallback)((sprite, script, allSprites) => {
    ...
    const handleCollision = (newX, newY) => {
      const collidedSprite = allSprites.find(otherSprite => otherSprite.id !== updatedSprite.id && checkCollision({
        ...updatedSprite,
        x: newX,
        y: newY
      }, otherSprite));
      if (collidedSprite) {
        ...
        setSprites(prevSprites => prevSprites.map(s => s.id === updatedCollidedSprite.id ? updatedCollidedSprite : s));
        return true;
      }
      return false;
    };
    ...
    switch (script.type) {
      case 'motion-move':
        ...
        if (moveX <= SPRITE_SIZE / 2 || moveX >= STAGE_WIDTH - SPRITE_SIZE / 2 || moveY <= SPRITE_SIZE / 2 || moveY >= STAGE_HEIGHT - SPRITE_SIZE / 2) {
  ...
  const executeAllScripts = (0,react.useCallback)((sprite, allSprites) => {
    if (!isRunningRef.current) return sprite;
    let updatedSprite = {
      ...sprite
    };
  ...
  const startForeverExecution = (0,react.useCallback)(spriteId => {
    const intervalId = setInterval(() => {
      if (isRunningRef.current) {
        setSprites(prevSprites => {
          const updatedSprites = prevSprites.map(sprite => sprite.id === spriteId ? executeAllScripts(sprite, prevSprites) : sprite);
  ...
  const stopAllScripts = (0,react.useCallback)(() => {
  ...
  const handleGreenFlag = (0,react.useCallback)(() => {
    try {
      stopAllScripts();
  ...
  const addScript = (0,react.useCallback)((spriteId, script) => {
    setSprites(prevSprites => prevSprites.map(sprite => sprite.id === spriteId ? {
      ...sprite,
  ...
  const addNewSprite = (0,react.useCallback)(() => {
    const newSprite = {
      id: Date.now(),
  ...
  const handleSpriteDrag = (0,react.useCallback)((spriteId, newX, newY) => {
    setSprites(prevSprites => prevSprites.map(sprite => sprite.id === spriteId ? {
      ...sprite,
  ...
  const onDragEnd = (0,react.useCallback)(result => {
    const {
      source,
      destination,
      draggableId
    ...
    if (source.droppableId === 'block-palette' && destination.droppableId === 'script-area') {
      setSprites(prevSprites => prevSprites.map(sprite => sprite.id === selectedSpriteId ? {
        ...sprite,
        scripts: [...sprite.scripts, {
  ...
  const deleteScript = (spriteId, scriptId) => {
    setSprites(prevSprites => prevSprites.map(sprite => sprite.id === spriteId ? {
      ...sprite,
      scripts: sprite.scripts.filter(script => script.id !== scriptId)
    } : sprite));
  };
  ...
  const handleReset = (0,react.useCallback)(() => {
    setSprites(prevSprites => prevSprites.map(sprite => ({
      ...
      direction: 90,
      // or whatever the initial direction should be
      scripts: [] // Clear all scripts
    })));
  }, []);

  // Function to delete a sprite
  const deleteSprite = (0,react.useCallback)(spriteId => {
    setSprites(prevSprites => {
  ...
  return /*#__PURE__*/react.createElement(App_ErrorBoundary, null, /*#__PURE__*/react.createElement(DragDropContext, {
    onDragEnd: onDragEnd
  }, /*#__PURE__*/react.createElement("div", {
    className: "flex h-screen bg-gray-100"
  }, /*#__PURE__*/react.createElement(components_BlockPalette, null), /*#__PURE__*/react.createElement("div", {
    className: "flex-1 flex flex-col"
  }, /*#__PURE__*/react.createElement("div", {
    className: "p-4 bg-gradient-to-r from-blue-400 via-blue-300 to-blue-400 flex justify-between items-center border-b-2 border-gray-400 shadow-md"
  }, /*#__PURE__*/react.createElement("button", {
  ...
  }, /*#__PURE__*/react.createElement(components_SpriteSelector, {
    sprites: sprites,
  ...
  }, selectedSpriteId && /*#__PURE__*/react.createElement(components_ScriptArea, {
    sprite: sprites.find(s => s.id === selectedSpriteId),
    updateSprite: (id, updates) => setSprites(prevSprites => prevSprites.map(s => s.id === id ? {
      ...s,
      ...updates
    } : s)),
    deleteScript: deleteScript
  }))), /*#__PURE__*/react.createElement(components_Stage, {
    sprites: sprites,
    width: STAGE_WIDTH,
    height: STAGE_HEIGHT,
...
react_dom.render(/*#__PURE__*/react.createElement(react.StrictMode, null, /*#__PURE__*/react.createElement(src_App, null)), document.getElementById("root"));
})();
